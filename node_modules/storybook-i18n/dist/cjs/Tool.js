...
var getLocales = function getLocales(locales, locale, onSelect) {
  return locales ? Object.entries(locales).map(function (_ref) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_components.WithTooltip, {
    ...
    tooltip: function tooltip(_ref3) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_components.TooltipLinkList, {
        links: getLocales(locales, locale, function (selected) {
          if (selected !== locale) {
            updateGlobals({
              locale: selected
            });

            _addons.addons.getChannel().emit('LOCALE_CHANGED', selected);
          }
